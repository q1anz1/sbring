package sbringframwork.beans.factory.xml;
...
import sbringframwork.beans.factory.support.AbstractBeanDefinitionReader;
import sbringframwork.beans.factory.support.BeanDefinitionRegistry;
import sbringframwork.context.annotation.ClassPathBeanDefinitionScanner;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    public void loadBeanDefinitions(Resource resource) throws BeansException {
        try {
            ...
            throw new BeansException("读取XML文件异常，Resource: " + resource, e);
        }
    }
