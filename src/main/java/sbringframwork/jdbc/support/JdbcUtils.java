    ...
    public static void closeStatement(Statement stmt) {
        if (null != stmt) {
            try {
                ...
                throw new RuntimeException("Could not close JDBC statement " + e);
            }
        }
    }
    ...
    public static void closeResultSet(ResultSet rs) {
        if (rs != null) {
            try {
                ...
                throw new RuntimeException("Could not close JDBC ResultSet", ex);
            }
            catch (Throwable ex) {
                // We don't trust the JDBC driver: It might throw RuntimeException or Error.
                throw new RuntimeException("Unexpected exception on closing JDBC ResultSet", ex);
            }
        }
    }
